 ...
 * @description 
 */
trigger TRIG_Major_code on ucinn_ascendv2__Post_Code__c(after delete, after insert, after undelete, after update, before delete, before insert, before update) {
